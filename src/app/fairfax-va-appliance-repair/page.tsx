...
export const metadata: Metadata = createPageSEO(
  'Appliance Repair Fairfax VA - Same Day Service Available',
  'Professional appliance repair in Fairfax VA. Refrigerator, dryer, washer repair with same-day service available. 10+ years experience. Call (703) 555-0123!',
  '/fairfax-va-appliance-repair'
)
...
export default function FairfaxVAApplianceRepair() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Same Day Repairs provides expert appliance repair services in Fairfax VA.
              With 10+ years of experience, we serve the Fairfax community with professional, reliable appliance repair.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Professional Appliance Repair Services in Fairfax VA
            </h2>
          </div>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Need Appliance Repair in Fairfax VA Today?
          </h2>
          <p className="text-xl mb-8">
            Same Day Repairs provides fast, professional appliance repair service in Fairfax Virginia.
          </p>
