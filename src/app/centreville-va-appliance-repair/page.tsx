...
export const metadata: Metadata = createPageSEO(
  'Appliance Repair Centreville VA - Same Day Service Available',
  'Professional appliance repair in Centreville VA. Refrigerator, dryer, washer repair with same-day service available. 10+ years experience. Call (703) 555-0123!',
  '/centreville-va-appliance-repair'
)
...
export default function CentrevilleVAApplianceRepair() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Appliance Repair Centreville VA
              <span className="block text-2xl lg:text-3xl text-blue-200 mt-2">
                Same-Day Service Available
              </span>
            </h1>
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Same Day Repairs provides expert appliance repair services in Centreville VA.
              With 10+ years of experience, we serve the Centreville community with professional, reliable appliance repair.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Professional Appliance Repair Services in Centreville VA
            </h2>
          </div>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Need Appliance Repair in Centreville VA Today?
          </h2>
          <p className="text-xl mb-8">
            Same Day Repairs provides fast, professional appliance repair service in Centreville Virginia.
          </p>
