...
export const metadata: Metadata = createPageSEO(
  'Appliance Repair Manassas VA - Same Day Service Available',
  'Professional appliance repair in Manassas VA. Refrigerator, dryer, washer repair with same-day service available. 10+ years experience. Call (703) 555-0123!',
  '/manassas-va-appliance-repair'
)
...
export default function ManassasVAApplianceRepair() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Same Day Repairs provides expert appliance repair services in Manassas VA.
              With 10+ years of experience, we serve the Manassas community with professional, reliable appliance repair.
            </p>
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="text-center">
              <h2 className="text-xl font-semibold text-blue-800">
                Need Appliance Repair in Manassas VA? Same-Day Service Available!
              </h2>
              <p className="text-blue-700">
                Professional appliance repair service in Manassas Virginia. Same-day service available when scheduling permits.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Professional Appliance Repair Services in Manassas VA
            </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Serving Manassas Virginia with Professional Appliance Repair
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Manassas is a historic city in Northern Virginia with over 42,000 residents.
              Same Day Repairs has been proud to serve the Manassas community with reliable appliance repair services.
              From Old Town Manassas to residential neighborhoods throughout the city, we provide professional appliance repair.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Local Manassas Service</h3>
              <p className="text-gray-600">
                We know Manassas VA well and provide efficient appliance repair service throughout the city and surrounding areas.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Same-day appliance repair service available in Manassas when scheduling permits. We prioritize urgent repairs.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Over 10 years serving Northern Virginia families with professional appliance repair services.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Need Appliance Repair in Manassas VA Today?
          </h2>
          <p className="text-xl mb-8">
            Don&apos;t let broken appliances disrupt your life. Same Day Repairs provides fast,
            professional appliance repair service throughout Manassas Virginia.
          </p>
