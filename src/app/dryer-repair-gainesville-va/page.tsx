...
import { PhoneIcon, CheckIcon, ExclamationTriangleIcon, StarIcon, ClockIcon } from '@heroicons/react/24/solid'
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* Safety Notice */}
        <section id="safety-notice" className="bg-blue-50 border-l-4 border-blue-500 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
